...
var current_dialogue_node:DialogueNode = starting_dialogue_node
var prev_dialogue_node:DialogueNode

# Get the dialogue text of the current node
func get_current_dialogue_node_text():
	return current_dialogue_node.dialogue_text
...
func switch_dialogue_nodes(new_node:DialogueNode):
	...
	current_dialogue_node = new_node
